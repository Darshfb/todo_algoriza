            ...
            children: [
              Expanded(
                child: ListView.separated(
                  itemCount: cubit.completeData.length,
                  separatorBuilder: (context, index) => const SizedBox(
                    height: 10.0,
                  ),
                  itemBuilder: (context, index) {
                    var item = cubit.completeData[index];
                    return Row(
                      children: [
                        Checkbox(
                            ...
                            onChanged: (value) {
                              cubit.updateDatabaseCompleted(
                                  id: cubit.completeData[index]['id'],
                                  status: (cubit.completeData[index]['status'] ==
                                          "uncompleted")
                                      ? "completed"
                                      : "uncompleted");
                            },
                            ...
                            onSelected: (Menu item) {
                              if (item.name == 'delete') {
                                ...
                                cubit.updateDatabaseFav(
                                    id: cubit.completeData[index]['id'],
                                    favorite: (cubit.completeData[index]
                                                ['favorite'] ==
                                            "true")
                                        ? "false"
                                        : "true");
